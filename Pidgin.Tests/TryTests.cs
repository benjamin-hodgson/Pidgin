            ...
            Result<char, T> parseFunc<T>(Parser<char, T> parser, ReadOnlySpan<char> input) => parser.Parse(input);
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        ImmutableSortedSet.Create(new Expected<char>(ImmutableArray.CreateRange(render("bar")))),
                        new SourcePos(1,4),
                        null
                    ),
                    true
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        ImmutableSortedSet.Create(new Expected<char>(ImmutableArray.CreateRange(render("four")))),
                        new SourcePos(1,2),
                        null
                    ),
                    true
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        ImmutableSortedSet.Create(new Expected<char>(ImmutableArray.CreateRange(render("foo"))), new Expected<char>(ImmutableArray.CreateRange(render("four")))),
                        new SourcePos(1,1),
                        null
                    ),
                    false
            ...
            }
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        ImmutableSortedSet.Create(new Expected<char>(ImmutableArray.CreateRange(render("foobat")))),
                        new SourcePos(1, 6),
                        null
                    ),
                    true
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        ...
                        ImmutableSortedSet.Create(
                            new Expected<char>(ImmutableArray.CreateRange(render("foo"))),
                            new Expected<char>(ImmutableArray.CreateRange(render("foobat")))
                        ),
                        new SourcePos(1, 1),
                        null
                    ),
