        ...
        {
            {
                ...
                var expectedError = new ParseError<char>(
                    Maybe.Nothing<char>(),
                    false,
                    new[]{ new Expected<char>(ImmutableList.Create<char>()) },
                    new SourcePos(1,1),
                    "message"
                );
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[]{ new Expected<char>(ImmutableList.Create('a')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[]{ new Expected<char>(ImmutableList.Create('A')), new Expected<char>(ImmutableList.Create('a')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('b'),
                        false,
                        new[]{ new Expected<char>("foo".ToImmutableList()) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
            ...
            }
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('y'),
                        false,
                        new[] { new Expected<char>(ImmutableList.Create('x')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('x'),
                        false,
                        new[] { new Expected<char>(ImmutableList.Create('y')) },
                        new SourcePos(1,2),
                        null
                    ),
                    true
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[]{ new Expected<char>("ab".ToImmutableList()) },
                        new SourcePos(1,2),
                        null
                    ),
                    true
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('d'),
                        false,
                        new[]{ new Expected<char>("abc".ToImmutableList()) },
                        new SourcePos(1,3),
                        null
                    ),
                    true
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        false,
                        new[]{ new Expected<char>(ImmutableList.Create<char>()), new Expected<char>(ImmutableList.Create('a')) },
                        new SourcePos(1,1),
                        "test"
                    ),
                    false
            ...
            }
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('c'),
                        false,
                        new[]{ new Expected<char>(ImmutableList.Create('a')), new Expected<char>(ImmutableList.Create('b')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('d'),
                        false,
                        new[]{ new Expected<char>(ImmutableList.Create('a')), new Expected<char>(ImmutableList.Create('b')), new Expected<char>(ImmutableList.Create('c')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
            ...
            }
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('q'),
                        false,
                        new[]{ new Expected<char>("bar".ToImmutableList()), new Expected<char>("foo".ToImmutableList()) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        ...
                        new[]
                        {
                            new Expected<char>(ImmutableList.Create('A')),
                            new Expected<char>(ImmutableList.Create('B')),
                            new Expected<char>(ImmutableList.Create('C')),
                            new Expected<char>(ImmutableList.Create('a')),
                            new Expected<char>(ImmutableList.Create('b')),
                            new Expected<char>(ImmutableList.Create('c'))
                        },
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('e'),
                        false,
                        new[]{ new Expected<char>("using".ToImmutableList()) },
                        new SourcePos(1,5),
                        null
                    ),
                    true
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[] { new Expected<char>(ImmutableList.Create('f')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[] { new Expected<char>(ImmutableList.Create(' ')), new Expected<char>("foo ".ToImmutableList()) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[] { new Expected<char>("foofoofoo".ToImmutableList()) },
                        new SourcePos(1,7),
                        null
                    ),
                    true
            ...
            }
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('a'),
                        false,
                        new[] { new Expected<char>("digit"), new Expected<char>(ImmutableList.Create('+')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
