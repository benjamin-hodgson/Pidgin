        ...
        {
            {
                ...
                var expectedError = new ParseError<char>(
                    Maybe.Nothing<char>(),
                    false,
                    new[]{ new Expected<char>(Rope.Create<char>()) },
                    new SourcePos(1,1),
                    "message"
                );
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[]{ new Expected<char>(Rope.Create('a')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[]{ new Expected<char>(Rope.Create('A')), new Expected<char>(Rope.Create('a')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('b'),
                        false,
                        new[]{ new Expected<char>(Rope.CreateRange("foo")) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
            ...
            }
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('y'),
                        false,
                        new[] { new Expected<char>(Rope.Create('x')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('x'),
                        false,
                        new[] { new Expected<char>(Rope.Create('y')) },
                        new SourcePos(1,2),
                        null
                    ),
                    true
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[]{ new Expected<char>(Rope.CreateRange("ab")) },
                        new SourcePos(1,2),
                        null
                    ),
                    true
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('d'),
                        false,
                        new[]{ new Expected<char>(Rope.CreateRange("abc")) },
                        new SourcePos(1,3),
                        null
                    ),
                    true
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        false,
                        new[]{ new Expected<char>(Rope.Create<char>()), new Expected<char>(Rope.Create('a')) },
                        new SourcePos(1,1),
                        "test"
                    ),
                    false
            ...
            }
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('c'),
                        false,
                        new[]{ new Expected<char>(Rope.Create('a')), new Expected<char>(Rope.Create('b')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('d'),
                        false,
                        new[]{ new Expected<char>(Rope.Create('a')), new Expected<char>(Rope.Create('b')), new Expected<char>(Rope.Create('c')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
            ...
            }
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('q'),
                        false,
                        new[]{ new Expected<char>(Rope.CreateRange("bar")), new Expected<char>(Rope.CreateRange("foo")) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        ...
                        new[]
                        {
                            new Expected<char>(Rope.Create('A')),
                            new Expected<char>(Rope.Create('B')),
                            new Expected<char>(Rope.Create('C')),
                            new Expected<char>(Rope.Create('a')),
                            new Expected<char>(Rope.Create('b')),
                            new Expected<char>(Rope.Create('c'))
                        },
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('e'),
                        false,
                        new[]{ new Expected<char>(Rope.CreateRange("using")) },
                        new SourcePos(1,5),
                        null
                    ),
                    true
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[] { new Expected<char>(Rope.Create('f')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[] { new Expected<char>(Rope.Create(' ')), new Expected<char>(Rope.CreateRange("foo ")) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
        ...
        {
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Nothing<char>(),
                        true,
                        new[] { new Expected<char>(Rope.CreateRange("foofoofoo")) },
                        new SourcePos(1,7),
                        null
                    ),
                    true
            ...
            }
            {
                ...
                AssertFailure(
                    ...
                    new ParseError<char>(
                        Maybe.Just('a'),
                        false,
                        new[] { new Expected<char>("digit"), new Expected<char>(Rope.Create('+')) },
                        new SourcePos(1,1),
                        null
                    ),
                    false
